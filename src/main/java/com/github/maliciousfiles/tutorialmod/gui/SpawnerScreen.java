...
public class SpawnerScreen extends Screen {
    ...
    private ResourceLocation GUI = new ResourceLocation(TutorialMod.MODID, "textures/gui/spawner_gui.png");

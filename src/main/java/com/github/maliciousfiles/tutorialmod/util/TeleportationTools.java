...
public class TeleportationTools {
    ...
    public static ServerPlayerEntity teleport(ServerPlayerEntity entity, DimensionType destination, BlockPos pos) {
        ...
        ServerWorld originalWorld = DimensionManager.getWorld(entity.server, source, true, true);
        entity.dimension = destination;
        ServerWorld destinationWorld = DimensionManager.getWorld(entity.server, destination, true, true);
